						...
						<?php
							...
							while($row = mysql_fetch_array($tache_critique_results)){
								...
								if(isset($Membre_equipeID)){
									...
									$Membre_equipe = $Membre_equipe['Nom']."(<a href='affecter_tache.php?id_tache=".$id_tache."&type_tache=".$type_tache."'>Affecter cette tache à un autre membre</a>)";				
								}else{
									$Membre_equipe = "Aucun membre n'est affecté à cette tache(<a href='affecter_tache.php?id_tache=".$id_tache."&type_tache=".$type_tache."'>Affecter cette tache à un membre</a>)";
								}
								echo "<tr> 
										<td>".$Nom_tache."</td>
										<td>".$Desc_tache."</td>
